...
import {
  SummaryCards, TokenHeatmap, formatTokens, formatMoney, useHistory,
} from './UsageHeatmap.tsx'
 ...
 * style) plus balance/cost summary cards. Data arrives from the host's
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <span style={captionStyle}>
            {payload.days.length === 0
              ...
              : `Last ${payload.days.length} days · ${formatTokens(windowTokens)} tokens · ${formatMoney(windowCost, payload.currency)}`}
          </span>
