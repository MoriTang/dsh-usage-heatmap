...
var LEVEL_THRESHOLDS = [1e4, 1e6, 5e7];
...
function levelRangeLabel(level) {
  switch (level) {
    case 0:
      return "No usage";
    case 1:
      return `< ${formatTokens(LEVEL_THRESHOLDS[0])}`;
    case 2:
      return `${formatTokens(LEVEL_THRESHOLDS[0])}\u2013${formatTokens(LEVEL_THRESHOLDS[1])}`;
    case 3:
      return `${formatTokens(LEVEL_THRESHOLDS[1])}\u2013${formatTokens(LEVEL_THRESHOLDS[2])}`;
    case 4:
      return `\u2265 ${formatTokens(LEVEL_THRESHOLDS[2])}`;
    default:
      return "";
  }
}
...
function TokenHeatmap({ days }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        monthSpans.map(({ col, label, span }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "span",
          {
            style: {
...
function HeatmapLegend() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 4, fontSize: 9, lineHeight: "12px", color: "var(--dsw-alias-label-tertiary)" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Less" }),
    [0, 1, 2, 3, 4].map((level) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
function Cell({ cell, level }) {
  ...
  if (cell.future) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { "data-usage-heatmap-cell": true, "data-level": 0, style: cellBaseStyle() });
  }
  const label = cellTooltipLabel(cell);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Tooltip, { label, side: "top", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { "data-usage-heatmap-cell": true, "data-level": level, style: cellBaseStyle() }) });
}
function cellTooltipLabel(cell) {
  const lines = [`${cell.date} \xB7 ${formatTokensFull(cell.tokens)} tokens`];
...
var UsageHeatmapSection = (0, import_react2.memo)(function UsageHeatmapSection2(_props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: wrapStyle, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 12 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HeatmapLegend, {})
    ] }),
...
// src/client/usage-heatmap.css
var usage_heatmap_default = ":root {\n  --dsh-usage-heatmap-level-0: rgb(0 0 0 / 9%);\n  --dsh-usage-heatmap-level-1: #9be9a8;\n  --dsh-usage-heatmap-level-2: #40c463;\n  --dsh-usage-heatmap-level-3: #30a14e;\n  --dsh-usage-heatmap-level-4: #216e39;\n  --dsh-usage-heatmap-cell-border: rgb(27 31 36 / 6%);\n}\n\nbody[data-ds-dark-theme] {\n  --dsh-usage-heatmap-level-0: #161b22;\n  --dsh-usage-heatmap-level-1: #0e4429;\n  --dsh-usage-heatmap-level-2: #006d32;\n  --dsh-usage-heatmap-level-3: #26a641;\n  --dsh-usage-heatmap-level-4: #39d353;\n  --dsh-usage-heatmap-cell-border: rgb(240 246 252 / 3%);\n}\n\n[data-usage-heatmap-cell] {\n  border: 0;\n  background: var(--dsh-usage-heatmap-level-0);\n  box-shadow: inset 0 0 0 1px var(--dsh-usage-heatmap-cell-border);\n}\n\n[data-usage-heatmap-cell][data-level='1'] {\n  background: var(--dsh-usage-heatmap-level-1);\n}\n\n[data-usage-heatmap-cell][data-level='2'] {\n  background: var(--dsh-usage-heatmap-level-2);\n}\n\n[data-usage-heatmap-cell][data-level='3'] {\n  background: var(--dsh-usage-heatmap-level-3);\n}\n\n[data-usage-heatmap-cell][data-level='4'] {\n  background: var(--dsh-usage-heatmap-level-4);\n}\n";
...
function apply(ctx) {
  ctx.effect(() => {
    ...
    style.textContent = usage_heatmap_default;
